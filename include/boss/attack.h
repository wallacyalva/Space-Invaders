...
// int findIndexActiveBoss(Game &game, int randN, int add = 0, int initialRandN = -1) {
...
void makeAttackBoss(Gamemap &gamemap, Game &game){

        COORD pos = {game.boss.position.X,(SHORT)(game.boss.position.Y + 1)};
